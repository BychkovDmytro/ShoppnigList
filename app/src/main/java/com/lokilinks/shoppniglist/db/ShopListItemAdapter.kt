...
import com.lokilinks.shoppniglist.databinding.ShopLibraryListItemBinding
import com.lokilinks.shoppniglist.databinding.ShopListItemBinding
        ...
        private fun setPaintFlagAndColor(binding: ShopListItemBinding) {
            binding.apply {
                if (chBox.isChecked){
                    ...
                    tvInfo.setTextColor(ContextCompat.getColor(binding.root.context, R.color.grey_dark))
                } else{
