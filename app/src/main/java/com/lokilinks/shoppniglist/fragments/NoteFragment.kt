...
import com.lokilinks.shoppniglist.activities.NewNoteActivity
import com.lokilinks.shoppniglist.databinding.FragmentNoteBinding
import com.lokilinks.shoppniglist.db.MainViewModel
import com.lokilinks.shoppniglist.db.NoteAdapter
    ...
    private fun onEditResult(){
        editLauncher = registerForActivityResult(ActivityResultContracts.StartActivityForResult()){
            if (it.resultCode == Activity.RESULT_OK){
                val editeState = it.data?.getStringExtra(EDIT_STATE_KEY)
                if (editeState == "update"){
